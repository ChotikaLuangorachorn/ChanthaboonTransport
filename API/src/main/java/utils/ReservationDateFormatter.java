...
public class ReservationDateFormatter {
    ...
    private SimpleDateFormat uiTimeFullFormatter = new SimpleDateFormat("HH:mm:ss", Locale.ENGLISH);
    private SimpleDateFormat uiTimeFormatter = new SimpleDateFormat("HH:mm", Locale.ENGLISH);
